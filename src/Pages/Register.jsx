...
const Register = () => {
    ...
    return (
        <div>
            <BackGround>
                <h1 className="text-center font-bold text-3xl text-white mb-4">Create Account</h1>
                <form onSubmit={handleRegister} action="" className=" bg-[#d1d5db66] sm:max-w-3xl sm:mx-auto rounded-lg p-6 space-y-2">
                    ...
                    <p className="text-white">Already have an account? <span className="text-green-400"><Link to={'/login'}>Login</Link></span></p>
                </form>
            </BackGround>
            <ToastContainer/>
        </div>
